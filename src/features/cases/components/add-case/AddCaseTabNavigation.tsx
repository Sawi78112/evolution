...
// Tab type for Add Case Modal
export type AddCaseTab = 'case-detail' | 'people' | 'artifacts' | 'notes' | 'related-cases';

// Tab Navigation Component
interface AddCaseTabNavigationProps {
  activeTab: AddCaseTab;
  onTabChange: (tab: AddCaseTab) => void;
}

export function AddCaseTabNavigation({ activeTab, onTabChange }: AddCaseTabNavigationProps) {
  const getTabClassName = (tabName: AddCaseTab) => {
