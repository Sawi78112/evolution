...
import { useAddCaseForm } from './hooks/useAddCaseForm';
...
export function CaseDetailTab({ onSubmit, onClose, isSubmitting = false }: CaseDetailTabProps) {
  const {
    formData,
    addressSuggestions,
          ...
          <div className="flex flex-col gap-3 flex-1">
            ...
            <div>
              ...
              <div className="bg-white dark:bg-gray-700 rounded-lg p-2 border border-purple-200 dark:border-purple-600/30">
                <p className="text-sm font-medium text-gray-900 dark:text-white">Will be set automatically</p>
              </div>
            </div>
            <div>
