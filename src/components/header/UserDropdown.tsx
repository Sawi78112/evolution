...
export default function UserDropdown() {
  ...
  const handleSignOut = async () => {
    ...
    try {
      ...
      if (result.success) {
        notification.success("Signed Out", "You've been successfully signed out.");
        router.push('/signin');
      } else {
        console.error('Logout failed:', result.error);
        notification.warning("Sign Out", "You've been signed out, but there was an issue with the server.");
  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-evolution-lg dark:border-gray-800 dark:bg-gray-dark"
      >
        <div>
        ...
        >
          {isLoggingOut ? (
            <svg className="animate-spin h-6 w-6 fill-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
